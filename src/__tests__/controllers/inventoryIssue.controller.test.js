...
jest.unstable_mockModule('../../models/inventoryIssue.model.js', () => ({
  default: {
    create: mockInventoryIssueCreate,
    validateStockAvailability: mockInventoryIssueValidateStockAvailability,
    ErrorMessages: mockInventoryIssueErrorMessages,
  },
}));
...
jest.unstable_mockModule('../../models/inventoryLot.model.js', () => ({
  default: {
    findById: mockInventoryLotFindById,
...
describe('InventoryIssueController.createInventoryIssue', () => {
  ...
  describe('Validation Tests', () => {
    ...
    it('should support totalQuantity field instead of quantity', async () => {
      ...
      mockInventoryIssueCreate.mockResolvedValue([
        {
          _id: 'issue-id-123',
          issueCode: 'IX000001',
          warehouseId: 'warehouse-id-123',
  ...
  describe('Success Tests - Auto FEFO Allocation', () => {
    it('should create inventory issue successfully with auto FEFO allocation', async () => {
      ...
      mockInventoryLotFindById
        .mockReturnValueOnce({
          session: jest.fn().mockResolvedValue(mockLot1),
        })
        .mockReturnValueOnce({
          session: jest.fn().mockResolvedValue(mockLot2),
        });
      ...
      mockInventoryIssueCreate.mockResolvedValue([mockCreatedIssue]);
  ...
  describe('Success Tests - Manual Lot Selection', () => {
    it('should create inventory issue with manual lot selection', async () => {
      ...
      mockInventoryLotFindById.mockReturnValue({
        session: jest.fn().mockResolvedValue(mockLot),
      });
  ...
  describe('Error Handling Tests', () => {
    it('should handle ValidationError', async () => {
      ...
      mockInventoryIssueCreate.mockRejectedValue(validationError);
